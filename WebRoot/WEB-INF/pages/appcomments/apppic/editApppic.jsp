...
<html>
<head>
<title>Edit <fmt:message key="appcomments.title"/> <fmt:message key="apppic.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveAppcommentsApppic" method="POST" modelAttribute="apppic">
			...
			<script type="text/javascript">Spring.addDecoration(new Spring.ValidateAllDecoration({elementId:'save', event:'onclick'}));</script>
				<input type="hidden" name="appcomments_appcommentsid" value="${appcomments_appcommentsid}" >
