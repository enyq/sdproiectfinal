...
<html>
<head>
<title>Edit <fmt:message key="apppic.title"/> <fmt:message key="appcomments.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveApppicAppcommentses" method="POST" modelAttribute="appcomments">
